  ...
  return (
    <SheetPortal data-slot="sheet-portal">
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex flex-col border-border bg-background shadow-lg outline-none ease-drawer data-[state=closed]:animate-out data-[state=closed]:duration-250 data-[state=open]:animate-in data-[state=open]:duration-300",
          side === "left" &&
