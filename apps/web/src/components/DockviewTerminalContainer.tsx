...
// ---------------------------------------------------------------------------
// Instance id helper now lives in `lib/leaf-instance-ids` (shared with the
// unified center dockview). Re-exported so existing importers keep resolving
// it from here.
// ---------------------------------------------------------------------------

import { newTerminalId } from "../lib/leaf-instance-ids";

export { newTerminalId };
