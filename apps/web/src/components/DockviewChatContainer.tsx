...
// ---------------------------------------------------------------------------
// Instance id + fresh-flag helpers now live in `lib/leaf-instance-ids` so the
// unified center dockview and this (mobile-only) container mint ids the same
// way. Re-exported so existing importers (e.g. `ChatPane`) keep resolving them
// from here.
// ---------------------------------------------------------------------------

import { consumeChatFresh, markChatFresh, newChatId } from "../lib/leaf-instance-ids";

export { consumeChatFresh, markChatFresh, newChatId };
